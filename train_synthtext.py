...
def parse_args():
    ...
    parser.add_argument('--devkit-path', dest='devkit_path', help='data',
    ...
    parser.add_argument('--log', dest='log_file', type=str, default="train_SynthText.log",
